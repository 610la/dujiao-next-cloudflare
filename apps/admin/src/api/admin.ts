...
export const adminAPI = {
  ...
  getCloudflareEmailStatus: () => api.get('/admin/settings/smtp/cloudflare/status'),
  onboardCloudflareEmailSending: (data: Record<string, unknown> = {}) =>
    api.post('/admin/settings/smtp/cloudflare/onboard', data),
